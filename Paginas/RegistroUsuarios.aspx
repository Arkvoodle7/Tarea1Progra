        ...
        <div class="iniciarS-form">
            <asp:Panel ID="RegistroPanel" runat="server" CssClass="panel">
                ...
                <div class="form-group">
                    ...
                    <p>
                        <asp:TextBox ID="txtCorreo" CssClass="form-control" runat="server" placeholder="Correo Electrónico"></asp:TextBox>
                    </p>
                </div>
                <div class="form-group">
                    <asp:Label ID="lblContrasena" runat="server" Text="Contraseña"></asp:Label>
                    <p>
                        <asp:TextBox ID="txtContrasena" CssClass="form-control" runat="server" TextMode="Password" placeholder="Contraseña"></asp:TextBox>
                    </p>
                </div>
                <div class="form-group">
